...
// =====================================
#define PROTOCOL_24 15
#define PROTOCOL_96 17
...
// -------- MotorZ setup --------
const int Zup  = 5;   // DIR+ for MotorY
const int Zdown = 7;   // PUL+ for MotorY

// -------- Limit switch setup --------
const int limitSwitchY = 10; // X-axis limit switch pin
const int limitSwitchX= 12; // Y-axis limit switch pin
