...
// =====================================
// -------- MotorX setup --------
const int stepPinX = 3;   // PUL+ for MotorX
const int dirPinX  = 5;   // DIR+ for MotorX
const int enPinX   = 7;   // ENA+ for MotorX
// -------- MotorY setup --------
...
void loop() {
  ...
  enableMotorY();
  enableMotorX();
  moveMotorX(LOW, (pulsesPerMMX * 33));
  delay(2000);
  moveMotorX(HIGH, (pulsesPerMMX * 33));
  delay(1000);
