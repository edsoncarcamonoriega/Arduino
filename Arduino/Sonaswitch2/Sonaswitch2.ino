...
void homeMotorY() {
  ...
  delay(500);
  moveMotorY(HIGH, (pulsesPerMMY * 10));
  delay(500);
...
void loop() {
  ...
  const unsigned long long_sonication = 570000; //150000
  const unsigned long short_sonication = 150000; //570000
  ...
  enableMotorX();
    ...
    //moveMotorY(HIGH, (pulsesPerMMX * 36));  
  ...
  if (PROTOCOL96 == LOW) {
    ...
    //Q5
    moveMotorX(HIGH, (pulsesPerMMX * 312));
    delay(500);
    moveMotorY(HIGH, (pulsesPerMMY * 36));
    delay(500);
    Sonicate(short_sonication);
